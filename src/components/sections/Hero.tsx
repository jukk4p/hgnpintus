...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[70vh] md:min-h-[90vh] w-full overflow-hidden flex items-center border-b-4 border-black bg-secondary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="space-y-6 md:space-y-8 animate-fade-in-up">
            <div className="space-y-2">
              <span className="inline-block bg-primary text-white px-3 py-1 text-xs md:text-sm font-black uppercase tracking-widest border-2 border-black mb-4">
                Líderes en Sevilla
              </span>
              <h1 className="text-3xl sm:text-6xl md:text-8xl font-black uppercase tracking-tighter leading-[0.9] md:leading-[0.95]">
                PINTURA <br />
                <span className="text-primary bg-white px-2">PROFESIONAL</span><br className="hidden sm:block" />
                & VERTICAL
              </h1>
            </div>
            <p className="text-base md:text-2xl font-bold max-w-2xl text-gray-200 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button asChild size="lg" variant="outline" className="w-full sm:w-auto bg-white text-black h-16 text-lg">
